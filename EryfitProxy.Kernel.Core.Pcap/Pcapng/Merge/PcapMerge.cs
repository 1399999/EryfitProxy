namespace EryfitProxy.Kernel.Core.Pcap.Pcapng.Merge
{
    ...
    ///  produced by eryfit and does not cover pcap files that comes from other sources.
    ...
    public static class PcapMerge
    {
            ...
            int maxConcurrentOpenFile = 20)
        {
            ...
            merger.Merge(blockHandler, f => new EnhancedBlockReader(blockHandler, streamLimiter, f),
                pcapFiles.ToArray());
        }

        /// <summary>
        ///     Merge from a eryfit dump directory
        /// </summary>
