...
{
    /// <summary>
    ///  An HttpMessageHandler that uses eryfit internals to send requests and forces connection to be HTTP/2.
    ///  Unless you know what you are doing, you should not use this class directly instead of HttpClientHandler.
    /// </summary>
    public class EryfitHttp2Handler : HttpMessageHandler, IAsyncDisposable
    {
        ...
        public EryfitHttp2Handler(H2StreamSetting? streamSetting = null)
        {
