...
{
    /// <summary>
    ///  An HttpMessageHandler that uses eryfit internals to send requests and forces connection to be HTTP/1.1.
    ///  Unless you know what you are doing, you should not use this class directly instead of HttpClientHandler.
    /// </summary>
    public class EryfitHttp11Handler : HttpMessageHandler
    {
        ...
        public EryfitHttp11Handler(SslProvider sslProvider = SslProvider.OsDefault)
        {
