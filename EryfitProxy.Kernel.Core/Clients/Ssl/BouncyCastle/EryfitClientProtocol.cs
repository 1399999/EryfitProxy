...
{
    internal class EryfitClientProtocol : TlsClientProtocol
    {
        ...
        public EryfitClientProtocol(Stream stream, FingerPrintTlsExtensionsEnforcer _extensionEnforcer, NssLogWriter logWriter)
            : base(stream)
        {
...
#pragma warning restore CS0618
        ...
        protected override void CompleteHandshake()
        {
            ...
            if (ProtocolVersion.IsEqualOrEarlierVersionOf(ProtocolVersion.TLSv12) &&
                Context.Crypto is EryfitCrypto crypto && crypto.MasterSecret != null) {
