...
namespace EryfitProxy.Kernel.Clients.H2.Encoder.Utils
{
    public sealed class Http11Constants
    {
        ...
        public static readonly ReadOnlyMemory<char> EryfitLiveEdit = "x-eryfit-live-edit".AsMemory();
        ...
        public static readonly HashSet<ReadOnlyMemory<char>> NonH2Header =
            new(new[] {
                ConnectionVerb, KeepAliveVerb, ProxyAuthenticate, Trailer, Upgrade, AltSvc, Expect, EryfitLiveEdit
            }, new SpanCharactersIgnoreCaseComparer());
