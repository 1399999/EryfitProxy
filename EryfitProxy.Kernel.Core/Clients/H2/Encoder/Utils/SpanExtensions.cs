...
namespace EryfitProxy.Kernel.Clients.H2.Encoder.Utils
{
    internal static class SpanExtensions
    {
        ...
        /// <returns></returns>
        public static ReadOnlySpan<byte> SliceBitsToNextInt32(
            this ReadOnlySpan<byte> buffer, int offsetBits, Span<byte> destination, int shortestSymbolLength)
        {
            ...
            if (workBuffer.Length == 1) {
                ...
                var compare = (byte) (0xFF >> sliceRemains);
