...
namespace EryfitProxy.Kernel
{
    ...
    public class Proxy : IAsyncDisposable
    {
        ...
        /// <param name="proxyAuthenticationMethod">Use this authentication method instead of the one provided in EryfitSetting</param>
        public Proxy(
            EryfitSetting startupSetting,
        ...
        /// </summary>
        public EryfitSetting StartupSetting { get; }
        ...
        private async void ProcessingConnection(TcpClient client)
        {
            ...
            try {
                ...
                using var buffer = RsBuffer.Allocate(EryfitSharedSetting.RequestProcessingBuffer);
                ...
                try {
                    ...
                    var closeImmediately = EryfitSharedSetting.OverallMaxConcurrentConnections <
                                           currentCount;
