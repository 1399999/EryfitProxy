...
{
    /// <summary>
    /// Holds information about a downstream error (error between Eryfit and the client)
    /// </summary>
    [MessagePackObject]
    public class DownstreamErrorInfo
    {
        ...
        internal static DownstreamErrorInfo CreateFrom(TcpClient client, Exception ex)
        {
            ...
            return new DownstreamErrorInfo {
                ...
                RequiredHost = ex is EryfitException eryfitException ? eryfitException.TargetHost : null,
            }; 
        }
    }
}
