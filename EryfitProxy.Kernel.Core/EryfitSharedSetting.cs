...
{
    /// <summary>
    ///     Contains static low level settings for Eryfit
    /// </summary>
    public static class EryfitSharedSetting
    {
        static EryfitSharedSetting()
        {
        ...
        public static int DownStreamProviderReceiveTimeoutMilliseconds { get; } =
            EnvironmentUtility.GetInt32("ERYFIT_DOWNSTREAM_CONNECTION_RECEIVE_TIMEOUT_MILLISECONDS", -1);

        /// <summary>
        ///     Maximum number of connection per remote host
        /// </summary>
        public static int MaxConnectionPerHost { get; set; } =
            EnvironmentUtility.GetInt32("ERYFIT_MAX_CONNECTION_PER_HOST", 16);

        /// <summary>
        ///     Eryfit will use stackalloc for buffer allocation if the buffer size is less than this value.
        ///     Can bet set by environment variable ERYFIT_STACK_ALLOC_THRESHOLD
        /// </summary>
        public static int StackAllocThreshold { get; set; } =
            EnvironmentUtility.GetInt32("ERYFIT_STACK_ALLOC_THRESHOLD", 1024);

        /// <summary>
        ///     The running version of Eryfit
        /// </summary>
        ...
        public static int ProxyAuthenticationMaxAttempt { get; set; } =
            EnvironmentUtility.GetInt32("ERYFIT_PROXY_AUTHENTICATION_MAX_ATTEMPT", 3);
        ...
        public static int MaxProcessingBuffer { get; } =
            EnvironmentUtility.GetInt32("ERYFIT_MAX_PROCESSING_BUFFER", 1024 * 512);

        /// <summary>
        ///     Maximum length of an enhanced block in a pcapng file, default is 8KB
        /// </summary>
        public static int PcapEnhancedBlockMaxLength { get; } =
            EnvironmentUtility.GetInt32("ERYFIT_PCAP_ENHANCED_BLOCK_MAX_LENGTH", 8 * 1024);
