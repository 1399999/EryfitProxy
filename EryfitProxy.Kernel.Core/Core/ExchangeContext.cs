...
namespace EryfitProxy.Kernel.Core
{
    ...
    public class ExchangeContext
    {
        ...
        public ExchangeContext(
            ...
            VariableContext variableContext, EryfitSetting? eryfitSetting,
            SetUserAgentActionMapping setUserAgentActionMapping)
        {
            ...
            SetUserAgentActionMapping = setUserAgentActionMapping;
            SkipRemoteCertificateValidation = eryfitSetting?.SkipRemoteCertificateValidation ?? false;
        }
        ...
        /// <summary>
        ///     true if eryfit should not decrypt this exchange
        /// </summary>
        public bool BlindMode { get; set; }

        /// <summary>
        ///     If true, eryfit will not try to reuse an existing connection
        /// </summary>
