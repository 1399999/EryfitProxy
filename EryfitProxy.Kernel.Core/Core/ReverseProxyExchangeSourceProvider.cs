            ...
            CancellationToken token)
        {
            ...
            var sslServerAuthenticationOptions = new SslServerAuthenticationOptions {
                ...
                ServerCertificateSelectionCallback = (_, name) => {
                    var certificate = _certificateProvider.GetCertificate(string.IsNullOrWhiteSpace(name) ? "eryfit.io" : name);
                    authorityName = name;
                    return certificate;
                }
            };
            ...
            if (authorityName is null) {
                throw new EryfitException("Unable to gather remote authority hostname");
            }
