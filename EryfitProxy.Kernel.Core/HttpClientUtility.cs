...
{
    /// <summary>
    /// Utility class for creating HttpClient connected to a Eryfit instance.
    /// </summary>
    public static class HttpClientUtility
    {
        ...
        /// <param name="setting">The Eryfit setting containing the CA certificate.</param>
        /// <returns>An instance of <see cref="HttpMessageHandler"/>.</returns>
        public static HttpClientHandler CreateHttpMessageHandler(
            IReadOnlyCollection<IPEndPoint> endPoints, EryfitSetting setting)
        {
        ...
        /// <param name="setting">The EryfitSetting object containing the settings for the HttpClient.</param>
        ...
        public static HttpClient CreateHttpClient(IReadOnlyCollection<IPEndPoint> endPoints, 
            EryfitSetting setting, Action<HttpClientHandler>? configureHandler = null)
        {
