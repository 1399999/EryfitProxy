...
namespace EryfitProxy.Kernel.Misc.Streams
{
    public abstract class StringMatcher : IBinaryMatcher
    {
        ...
        public BinaryMatchResult FindIndex(ReadOnlySpan<byte> content, ReadOnlySpan<byte> searchText)
        {
            ...
            var searchTextArray = searchTextStringCount < EryfitSharedSetting.StackAllocThreshold
            ...
            var contentTextArray = contentTextStringCount < EryfitSharedSetting.StackAllocThreshold
