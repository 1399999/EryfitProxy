...
namespace EryfitProxy.Kernel.Certificates
{
    ...
    public abstract class CertificateAuthorityManager
    {
        ...
        {
            EryfitSecurityParams.Current.BuiltinCertificate.ExportToPem(stream);
        }
        ...
        //{
        //    return IsCertificateInstalled(EryfitSecurity.DefaultThumbPrint);
        //}
        ...
        {
            return InstallCertificate(EryfitSecurityParams.Current.BuiltinCertificate);
        }
