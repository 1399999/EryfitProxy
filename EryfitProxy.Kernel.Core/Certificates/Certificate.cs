...
namespace EryfitProxy.Kernel.Certificates
{
    ...
    public class Certificate
    {
        ...
        /// </summary>
        [JsonInclude]
        [PropertyDistinctive(Description = "Retrieve mode" , DefaultValue = "eryfitDefault")]
        public CertificateRetrieveMode RetrieveMode { get; set; } = CertificateRetrieveMode.EryfitDefault;
        ...
        /// <summary>
        ///   Get the default built-in eryfit certificate
        /// </summary>
        /// <returns></returns>
        public static Certificate UseDefault()
        {
            return new Certificate(CertificateRetrieveMode.EryfitDefault);
        }
        ...
        /// <exception cref="EryfitException"></exception>
        ...
        public X509Certificate2 GetX509Certificate()
        {
            ...
            switch (RetrieveMode) {
                case CertificateRetrieveMode.EryfitDefault:
                    return _cachedCertificate = EryfitSecurityParams.Current.BuiltinCertificate;
                ...
                case CertificateRetrieveMode.FromUserStoreThumbPrint: {
                    ...
                    if (certificate == null)
                        throw new EryfitException($"Could not retrieve certificate with thumbPrint `{ThumbPrint}`.");
