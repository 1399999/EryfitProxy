...
namespace EryfitProxy.Kernel.Rules.Actions.HighLevelActions
{
    ...
    public class ServeDirectoryAction : Action
    {
            ...
            BreakPointManager breakPointManager)
        {
            ...
            if (File.Exists(file.FullName)) {
                ...
                context.PreMadeResponse = new MockedResponseContent(200, new Clients.Mock.BodyContent(
                    ...
                    Headers = {
                        new MockedResponseHeader("Content-Type", contentType)
                    }
                };
            ...
            var indexFiles = new[] { "index.html", "index.htm" };
        ...
        public override IEnumerable<ValidationResult> Validate(EryfitSetting setting, Filter filter)
        {
