    ...
    public class AbsoluteUriFilter : StringFilter
    {
        ...
        public override IEnumerable<FilterExample> GetExamples()
        {
            yield return new FilterExample(
                "Select only exchanges with the URL matching exactly `https://www.eryfit.io/some-path`",
                new AbsoluteUriFilter(@"https://www.eryfit.io/some-path", StringSelectorOperation.Exact));
